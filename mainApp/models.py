...
class M_SubServices(models.Model):
    MainService = models.ForeignKey(
        M_Services, null=True, default=1, on_delete=models.SET_DEFAULT)
    title = models.CharField(max_length=1000)
    description = models.TextField()
    shortdescription = models.CharField(max_length=1000)
    status = models.CharField(max_length=1000)
...
class Profile(models.Model):
    ...
    first_count = models.IntegerField(
        default=0, help_text='It is 0, if the user is totally new and 1 if the user has saved his standard once')
...
class RServices(models.Model):
    MainService = models.ForeignKey(
        M_SubServices, null=True, default=1, on_delete=models.SET_DEFAULT)
    user = models.ForeignKey(
        User, null=True, default=1, on_delete=models.SET_DEFAULT)
    phone = models.CharField(max_length=1000)
    address = models.TextField()
    location = models.TextField()
    ServiceDate = models.CharField(max_length=1000)
